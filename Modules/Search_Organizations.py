...
def receive_search_inputs_organizations_database():
    '''
    ...
    search_organizations_database(search_item, search_value)


def search_organizations_database(search_item, search_value):
    '''
